...
namespace DemoV1b
{
    ...
    public interface IDemoV1bUserService
    {
        ...
        /// 400 -> Error
        /// </summary>
        Task<IEnumerable<L2User>> UsersGetByBirthdateAsync(DateTime date, CancellationToken cancellationToken = default);
        ...
        /// 400 -> Error
        /// </summary>
        Task<IEnumerable<L2User>> UsersSearchByDateAsync(DateTime before, DateTime after, int? maxResults = null, CancellationToken cancellationToken = default);
        ...
        /// 200 -> a list of neum
        /// </summary>
        Task<IEnumerable<L2MyEnumType>> ListEnumsAsync(L2MyEnumType? filter = null, CancellationToken cancellationToken = default);

        /// <summary>
        /// 200 -> a list of neum
        /// </summary>
        Task<IEnumerable<L2MyEnumType>> ListEnums2Async(L2MyEnumType filter, CancellationToken cancellationToken = default);
