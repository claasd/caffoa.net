...
namespace DemoV1a
{
    ...
    public class DemoV1aMaintainanceFunctions
    {
        private readonly ILogger<DemoV1aMaintainanceFunctions> _logger;
        private readonly ICaffoaFactory<IDemoV1aMaintainanceService> _factory;
        ...
        public DemoV1aMaintainanceFunctions(ILogger<DemoV1aMaintainanceFunctions> logger, ICaffoaFactory<IDemoV1aMaintainanceService> factory, ICaffoaErrorHandler errorHandler = null, ICaffoaJsonParser jsonParser = null, ICaffoaResultHandler resultHandler = null, ICaffoaConverter converter = null) {
            _logger = logger;
            _factory = factory;
