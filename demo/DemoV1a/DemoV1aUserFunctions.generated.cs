    ...
    public class DemoV1aUserFunctions
    {
            ...
            HttpRequest request)
        {
            try {
                ...
                return _resultHandler.Result(result, 201, caffoaResultParameter);
            } catch(CaffoaClientError err) {
                return err.Result;
            } catch (Exception e) {
            ...
            HttpRequest request, string userId)
        {
            try {
                ...
                return _resultHandler.Result(result, code, caffoaResultParameter);
            } catch(CaffoaClientError err) {
                return err.Result;
            } catch (Exception e) {
            ...
            HttpRequest request)
        {
            try {
                var instance = _factory.Instance(request);
                var parsedRequestBody = await _jsonParser.Parse<L1GroupedOneOf>(request.Body);
                var caffoaResultParameter = new CaffoaResultHandlerParameter(
                    new int[] { 200 },
                    new string[] { "application/json" },
                    request,
            ...
            HttpRequest request)
        {
            try {
                var instance = _factory.Instance(request);
                var parsedRequestBody = await _jsonParser.Parse<IEnumerable<L1AnyUser>>(request.Body);
                var caffoaResultParameter = new CaffoaResultHandlerParameter(
                    new int[] { 200 },
                    new string[] { "application/json" },
                    request,
