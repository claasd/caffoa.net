...
public class DemoV2AspNetNewtonSoftUserController : ControllerBase
{
    ...
    ///</summary>
    [HttpGet("users/xml")]
    public async Task<ActionResult<IEnumerable<ASPNAnyCompleteUser>>> UsersGetXmlAsync([FromQuery] int offset = 0, [FromQuery] int limit = 1000, CancellationToken cancellationToken = default) { return StatusCode(200, await GetService().UsersGetAsync(offset, limit, cancellationToken)); }
