...
namespace DemoV3
{
    ...
    public interface IDemoV3UserService : IAsyncDisposable
    {
        ...
        /// 400 -> Error
        /// </summary>
        Task<IEnumerable<User>> UsersGetByBirthdateAsync(DateTimeOffset date, CancellationToken cancellationToken = default);
        ...
        /// 400 -> Error
        /// </summary>
        Task<IEnumerable<User>> UsersSearchByDateAsync(DateTimeOffset before, DateTimeOffset after, int? maxResults = null, CancellationToken cancellationToken = default);
