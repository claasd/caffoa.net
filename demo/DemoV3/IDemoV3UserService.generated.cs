...
namespace DemoV3
{
    ...
    public interface IDemoV3UserService : IAsyncDisposable
    {
        ...
        /// 400 -> Error
        /// </summary>
        Task<IEnumerable<User>> UsersGetByBirthdateAsync(DateTime date, CancellationToken cancellationToken = default);
        ...
        /// 400 -> Error
        /// </summary>
        Task<IEnumerable<User>> UsersSearchByDateAsync(DateTime before, DateTime after, int? maxResults = null, CancellationToken cancellationToken = default);
